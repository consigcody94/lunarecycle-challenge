...
Examples:
    ...
    parser.add_argument("--version", "-v", action="version", version=f"lunarecycle {__version__}")
    ...
    run_parser.add_argument(
        "--days", "-d", type=int, default=365, help="Mission duration in days (default: 365)"
    )
    run_parser.add_argument("--crew", "-c", type=int, default=4, help="Crew size (default: 4)")
    run_parser.add_argument(
        "--location",
        "-l",
        type=str,
    ...
    run_parser.add_argument(
        "--frequency", "-f", type=int, default=7, help="Processing frequency in days (default: 7)"
    )
    run_parser.add_argument("--output", "-o", type=str, help="Output file path for report")
    run_parser.add_argument("--csv", type=str, help="Export daily metrics to CSV file")
    ...
    compare_parser.add_argument(
        "--days", "-d", type=int, default=365, help="Mission duration for comparison (default: 365)"
    )
    compare_parser.add_argument(
        "--technologies",
        "-t",
...
def cmd_run(args):
    ...
    if args.output:
        generate_summary_report(results, Path(args.output))
...
def cmd_compare(args):
    ...
    comparison = compare_technologies(days=args.days, technologies=args.technologies)
